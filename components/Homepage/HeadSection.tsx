...
export default function HeadSection() {
  ...
  return (<header className='w-full h-screen flex flex-col'>
    {/*Navigation bar*/}
    ...
    <div className='w-full h-[calc(100%-3rem)]'>
      ...
      <div className='w-full h-full flex flex-col justify-center items-center gap-4 z-[1] relative'>
        {/*Big Text*/}
        <div className='max-w-2xl text-4xl text-center font-bold cursor-go-big '>
          Effortless Sharing, Powerful Analytics
        </div>

        {/*Small Text*/}
        <div className='max-w-3xl text-center text-sm cursor-go-big  p-2'>
